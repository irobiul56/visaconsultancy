...
const submit = () => {
    ...
    form.post(route('step.store'), {
        forceFormData: true,
        onSuccess: () => {
            ElMessage({ type: 'success', message: 'Step created successfully!' });
        },
        onError: () => {
            ElMessage({ type: 'error', message: 'Failed to create step. Please try again.' });
        }
    });
};
</script>
...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="text-xl font-semibold leading-tight text-gray-800">Step</h2>
        </template>
            ...
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <h1 class="mb-4 text-lg font-semibold">Create a New Step</h1>
