...
const updateService = () => {
    ...
    })).post(route("service.update", props.service.id), {
        forceFormData: true, // Ensures FormData is used correctly
        onSuccess: () => {
            ElMessage.success("Service updated successfully!");
        },
        onError: () => {
            ElMessage.error("Failed to update service. Please try again.");
        }
    });
};
            ...
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <h1 class="mb-4 text-lg font-semibold">Edit Service</h1>
                        <form @submit.prevent="updateService">
                          <div class="mb-4 w-3/4 gap-6 pr-4">
                            ...
                            <div class="flex space-x-2 mt-4">
                                ...
                                <Link :href="route('service.index')" class="bg-gray-500 text-white px-4 py-2 rounded hover:bg-gray-600">
                                    Cancel
                                </Link>
                            </div>
                        </form>
